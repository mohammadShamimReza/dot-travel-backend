...
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.USER), (0, validateRequest_1.default)(User_validation_1.UserValidation.update), User_controller_1.UserController.updateUser);
