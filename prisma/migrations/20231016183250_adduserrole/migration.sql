/*
  ...
  - The values [client] on the enum `UserEnum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "UserEnum_new" AS ENUM ('super_admin', 'admin', 'host', 'user');
